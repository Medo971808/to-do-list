<template>
  ...
  >
    ...
    <section class="w-full px-2 text-md text-gray-600 mt-3 mb-12 max-h-">
      <router-link :to="{name: 'Today'}" class="w-full flex items-center bg-gray-200 rounded-xl px-1 mb-3">
        <span class="w-5 h-3 bg-[#FF0000] rounded-full mr-2"></span>Today
      </router-link>
      <router-link :to="{name: 'Tomorrow'}" class="w-full flex items-center bg-gray-200 rounded-xl px-1 mb-3">
        <span class="w-5 h-3 bg-[#61FF00] rounded-full mr-2"></span>Tomorrow
      </router-link>
      <router-link :to="{name: 'Week'}" class="w-full flex items-center bg-gray-200 rounded-xl px-1 mb-3">
        <span class="w-5 h-3 bg-[#5D7DF0] rounded-full mr-2"></span>This Week
      </router-link>
      <router-link 
      :to="{name: 'NewTask'}" 
