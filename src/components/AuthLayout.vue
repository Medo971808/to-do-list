<template>
  <main
    class="flex min-h-screen bg-gradient-to-br from-[#111827] via-[#1f2937] to-black items-center justify-center p-4"
  >
    <section class="lg:w-2/5 lg:block hidden lg:h-[87vh] lg:mr-10 lg:mb-0">
      <img
        src="../assets/tidyDay.png"
